...
1. [Releases](https://github.com/tjeodjq/welaaa/releases)에서 `welaaa-1.1.24.zip`을 받습니다. 비공개 저장소는 Git URL 설치가 되지 않으므로 ZIP을 사용하세요.
